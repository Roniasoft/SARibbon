...
public:
    ...
    void setupMinimizeButton(bool on)
    {
        ...
        if (on) {
            ...
            buttonMinimize->setObjectName(QStringLiteral("SACloseWindowButton"));
            ...
            buttonMinimize->setIconSize(QSize(20, 20));
            buttonMinimize->show();
...
//            buttonMaximize->show();
            ...
            buttonMaximize->setObjectName(QStringLiteral("SACloseWindowButton"));
            buttonMaximize->setFlat(true);
            ...
            buttonMaximize->setIconSize(QSize(20, 20));
            buttonMaximize->show();
